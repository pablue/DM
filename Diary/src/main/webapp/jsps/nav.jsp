	...
	<div class="container">
		...
		<div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li><a href="type!list.action"><span class="glyphicon glyphicon-book"></span> 日记分类管理</a></li>
				<li><a href="userAction!mainUI.action"><span class="glyphicon glyphicon-user"></span> 个人中心</a></li>
			</ul>
		</div>
	</div>
</nav>
